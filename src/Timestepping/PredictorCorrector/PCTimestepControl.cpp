...
namespace EPMDynamo {
   ...
   PCTimestepControl::PCTimestepControl(TimestepParameters &tsParams, const EquationParameters &eqParams)
      : TimestepControlBase(tsParams, eqParams, ElementaryCtrl, 2), mCorrectorIts(0), mCorrectionNorm(0.0), mOldCorrectionNorm(0.0)
   {
   }
