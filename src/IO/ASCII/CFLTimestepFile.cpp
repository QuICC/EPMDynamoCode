...
namespace EPMDynamo {
   ...
   void CFLTimestepFile::write()
   {
      if(this->doesIO())
      {
         ...
         // Write timestep
         this->mFile << this->mrTSParams.time() << "  " << this->mrTSParams.dt() << "   " << this->mrTSParams.globalCFLs().transpose() << "   " << this->mrTSParams.rtpCFLs().transpose() << "   " << this->mrTSParams.specCFLs().transpose() << "   " << this->mrTSParams.errCFLs().transpose() << "   " << this->mrTSParams.rtpCFLPos().transpose() << "   " << this->mrTSParams.specCFLPos().transpose() << "   " << this->mrTSParams.specCFLDeg().transpose() << std::endl;
