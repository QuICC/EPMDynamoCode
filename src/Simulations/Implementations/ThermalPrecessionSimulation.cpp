...
#include "Simulations/Implementations/ThermalPrecessionSimulation.hpp"
...
namespace EPMDynamo {
   ...
   ThermalPrecessionSimulation::ThermalPrecessionSimulation()
   ...
   void ThermalPrecessionSimulation::initEquations()
   {
   ...
   void ThermalPrecessionSimulation::configureTransforms()
   {
      //
   ...
   void ThermalPrecessionSimulation::updateEquationsRTP(const int step)
   {
   ...
   void ThermalPrecessionSimulation::updateEquationsRHS()
   {
   ...
   void ThermalPrecessionSimulation::transformEquationsRHS(const int step)
   {
      // Update RHS of the transport equation
   ...
   void ThermalPrecessionSimulation::addExternalInfluence()
   {
      // Add Thermal source term
      this->mTransport.addSourceTerm();
   }

   void ThermalPrecessionSimulation::timestepEquations()
   {
   ...
   void ThermalPrecessionSimulation::initFields()
   {
   ...
   void ThermalPrecessionSimulation::addHDF5Output()
   {
   ...
   void ThermalPrecessionSimulation::addASCIIOutput()
   {
