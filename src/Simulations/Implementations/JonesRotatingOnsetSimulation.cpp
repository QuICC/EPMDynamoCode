/** \file JonesRotatingOnsetSimulation.cpp
...
// Class include
//
#include "Simulations/Implementations/JonesRotatingOnsetSimulation.hpp"
...
namespace EPMDynamo {
   ...
   JonesRotatingOnsetSimulation::JonesRotatingOnsetSimulation()
   ...
   void JonesRotatingOnsetSimulation::initEquations()
   {
   ...
   void JonesRotatingOnsetSimulation::configureTransforms()
   {
      //
   ...
   void JonesRotatingOnsetSimulation::updateEquationsRTP(const int step)
   {
   ...
   void JonesRotatingOnsetSimulation::updateEquationsRHS()
   {
   ...
   void JonesRotatingOnsetSimulation::transformEquationsRHS(const int step)
   {
      // Update RHS of the transport equation
   ...
   void JonesRotatingOnsetSimulation::addExternalInfluence()
   {
      // Add Thermal source term
      this->mTransport.addSourceTerm();
   }

   void JonesRotatingOnsetSimulation::timestepEquations()
   {
   ...
   void JonesRotatingOnsetSimulation::initFields()
   {
   ...
   void JonesRotatingOnsetSimulation::addHDF5Output()
   {
   ...
   void JonesRotatingOnsetSimulation::addASCIIOutput()
   {
