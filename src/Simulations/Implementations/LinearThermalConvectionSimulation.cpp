/** \file LinearThermalConvectionSimulation.cpp
...
// Class include
//
#include "Simulations/Implementations/LinearThermalConvectionSimulation.hpp"
...
namespace EPMDynamo {
   ...
   LinearThermalConvectionSimulation::LinearThermalConvectionSimulation()
   ...
   void LinearThermalConvectionSimulation::initEquations()
   {
   ...
   void LinearThermalConvectionSimulation::configureTransforms()
   {
      //
   ...
   void LinearThermalConvectionSimulation::updateEquationsRTP(const int step)
   {
   ...
   void LinearThermalConvectionSimulation::updateEquationsRHS()
   {
   ...
   void LinearThermalConvectionSimulation::transformEquationsRHS(const int step)
   {
      // Update RHS of the transport equation
   ...
   void LinearThermalConvectionSimulation::addExternalInfluence()
   {
      // Add Thermal source term
      this->mTransport.addSourceTerm();
   }

   void LinearThermalConvectionSimulation::timestepEquations()
   {
   ...
   void LinearThermalConvectionSimulation::initFields()
   {
   ...
   void LinearThermalConvectionSimulation::addHDF5Output()
   {
   ...
   void LinearThermalConvectionSimulation::addASCIIOutput()
   {
