/** \file ThermalPrecessionSimulation.cpp
...
#include "Simulations/Implementations/ThermalPrecessionFrameSimulation.hpp"
...
namespace EPMDynamo {
   ...
   ThermalPrecessionFrameSimulation::ThermalPrecessionFrameSimulation()
   ...
   void ThermalPrecessionFrameSimulation::initEquations()
   {
   ...
   void ThermalPrecessionFrameSimulation::configureTransforms()
   {
      //
   ...
   void ThermalPrecessionFrameSimulation::updateEquationsRTP(const int step)
   {
   ...
   void ThermalPrecessionFrameSimulation::updateEquationsRHS()
   {
   ...
   void ThermalPrecessionFrameSimulation::transformEquationsRHS(const int step)
   {
      // Update RHS of the transport equation
   ...
   void ThermalPrecessionFrameSimulation::addExternalInfluence()
   {
      // Add Thermal source term
      this->mTransport.addSourceTerm();
   }

   void ThermalPrecessionFrameSimulation::timestepEquations()
   {
   ...
   void ThermalPrecessionFrameSimulation::initFields()
   {
   ...
   void ThermalPrecessionFrameSimulation::addHDF5Output()
   {
