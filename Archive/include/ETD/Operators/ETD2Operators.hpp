...
namespace EPMDynamo {
   ...
   template <typename TSim> class ETD2Operators: public ETDNOperators<TSim, 3>
   {
      public:
          ...
          */
         ETD2Operators(SmartSTrunc pTrunc);
   ...
   template <typename TSim> ETD2Operators<TSim>::ETD0Operators(SmartSTrunc pTrunc)
      : ETDOperators<TSim, 3>(pSTrunc)
   {
   }

   template <typename TSim> ETD2Operators<TSim>::~ETD0Operators()
   {
   }

   template <typename TSim> void ETD2Operators<TSim>::createOperators(const DynamoFloat h, const typename ETD0Operators<TSim>::BasisType &basis)
   {
