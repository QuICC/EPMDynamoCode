/** \file MagneticDiffusionRun.cpp
 *  \brief Magnetic diffusion simulation executable
 */
...
/**
 * @brief Magnetic diffusion simulation
 */
int runProgram()
{
   // Create the simulation object
   epm::Simulation<epm::WSHSimulation, epm::MagneticDiffusionSimulation>   sim;
