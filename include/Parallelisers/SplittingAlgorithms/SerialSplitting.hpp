 ...
 *  \brief Implementation of a serial code "load splitting" algorithm
 */
...
namespace EPMDynamo {
    ...
    * \brief Implementation of a serial code "load splitting" algorithm
    */
   class SerialSplitting: public LoadSplitterBase
   {
      public:
         /**
          * @brief Constructor
          ...
          * @param id ID of the current CPU/Core
          */
         SerialSplitting(SmartSimTrunc pSimTrunc, const int nCore, const int id);
