...
#include "Equations/Induction/InductionDummy.hpp"
#include "Equations/Transport/TransportDummy.hpp"
#include "Equations/NavierStokes/NavierStokesDummy.hpp"
...
namespace EPMDynamo {
    ...
    */
   class DummySimulation: public SimulationBase
   {
      public:
         /**
      ...
      private:
          ...
          */
         InductionDummy<DynamoTraits>    mInduction;

         /**
          * @brief Transport equation
          */
         TransportDummy<DynamoTraits>    mTransport;

         /**
          * @brief Navier Stokes equation
          */
         NavierStokesDummy<DynamoTraits>    mNavierStokes;
   };
