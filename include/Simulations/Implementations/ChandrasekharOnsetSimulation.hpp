/** \file ChandrasekharOnsetSimulation.hpp
 *  \brief Implementation of a linear thermal convection simulation
 */

#ifndef CHANDRASEKHARONSETSIMULATION_HPP
#define CHANDRASEKHARONSETSIMULATION_HPP
...
namespace EPMDynamo {
    ...
    */
   class ChandrasekharOnsetSimulation: public SimulationBase
   {
      public:
         /**
          * @brief Simple empty destructor
          */
         virtual ~ChandrasekharOnsetSimulation() {};

      protected:
         /**
          * @brief Constructor
          */
         ChandrasekharOnsetSimulation();

         /**
          * @brief Restrict solution to a specific (set of ) harmonic degree
          */
...
#endif // CHANDRASEKHARONSETSIMULATION_HPP
