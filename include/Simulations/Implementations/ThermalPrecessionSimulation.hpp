...
#ifndef THERMALPRECESSIONSIMULATION_HPP
#define THERMALPRECESSIONSIMULATION_HPP
...
#include "Equations/NavierStokes/NavierStokesThermalPrecession.hpp"
...
namespace EPMDynamo {
    ...
    */
   class ThermalPrecessionSimulation: public SimulationBase
   {
      public:
         /**
          * @brief Simple empty destructor
          */
         virtual ~ThermalPrecessionSimulation() {};

      protected:
         /**
          * @brief Constructor
          */
         ThermalPrecessionSimulation();
      ...
      private:
          ...
          */
         NavierStokesThermalPrecession<ThermalNLRotConvectionTraits> mNavierStokes;
   };

}

#endif // THERMALPRECESSIONSIMULATION_HPP
