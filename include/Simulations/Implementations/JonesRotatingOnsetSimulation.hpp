/** \file JonesRotatingOnsetSimulation.hpp
 *  \brief Implementation of a linear thermal convection simulation
 */

#ifndef JONESROTATINGONSETSIMULATION_HPP
#define JONESROTATINGONSETSIMULATION_HPP
...
namespace EPMDynamo {
    ...
    */
   class JonesRotatingOnsetSimulation: public SimulationBase
   {
      public:
         /**
          * @brief Simple empty destructor
          */
         virtual ~JonesRotatingOnsetSimulation() {};

      protected:
         /**
          * @brief Constructor
          */
         JonesRotatingOnsetSimulation();
      ...
      private:
          ...
          */
         NavierStokesRotConvection<LinearThermalConvectionTraits>    mNavierStokes;
   };

}

#endif // JONESROTATINGONSETSIMULATION_HPP
