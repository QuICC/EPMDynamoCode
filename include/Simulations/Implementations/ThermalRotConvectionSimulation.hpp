...
namespace EPMDynamo {
    ...
    * \brief Implementation of a thermal convection simulation
    */
   class ThermalRotConvectionSimulation: public SimulationBase
   {
      public:
         /**
      ...
      private:
          ...
          */
         ThermalRotConvectionTraits::CodType   mCodC;

         /**
          * @brief Velocity field
          */
         ThermalRotConvectionTraits::VelType   mVelV;

         /**
          * @brief Transport equation
          */
         TransportMHD<ThermalRotConvectionTraits>    mTransport;

         /**
          * @brief Navier Stokes equation
          */
         NavierStokesRotConvection<ThermalRotConvectionTraits>    mNavierStokes;
   };
