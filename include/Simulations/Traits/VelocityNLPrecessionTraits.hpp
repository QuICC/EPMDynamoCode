/** \file VelocityNLPrecessionTraits.hpp
 *  \brief Traits for the velocity diffusion simulation implementation
 */

#ifndef VELOCITYNLPRECESSIONTRAITS_HPP
#define VELOCITYNLPRECESSIONTRAITS_HPP
...
namespace EPMDynamo {
    ...
    * \brief Traits for the velocity diffusion simulation implementation
    */
   class VelocityNLPrecessionTraits
   {
      public:
...
#endif // VELOCITYNLPRECESSIONTRAITS_HPP
