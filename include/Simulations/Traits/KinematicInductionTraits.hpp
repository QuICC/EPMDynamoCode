/** \file KinematicInductionTraits.hpp
 *  \brief Traits for the kinematic induction simulation implementation
 */

#ifndef KINEMATICINDUCTIONTRAITS_HPP
#define KINEMATICINDUCTIONTRAITS_HPP
...
namespace EPMDynamo {
   ...
   /**
    * \brief Traits for the magnetic diffusion simulation implementation
    */
   class KinematicInductionTraits
   {
      public:
...
#endif // KINEMATICINDUCTIONTRAITS_HPP
