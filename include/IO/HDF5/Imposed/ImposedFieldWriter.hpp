...
namespace EPMDynamo {
   ...
   template <typename TSimType, template <typename> class TSimTraits> class ImposedFieldWriter: public ImposedFieldWriterBase
   {
      public:
         ...
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC, const typename TSimTraits<TSim>::MagType &magB, const typename TSimTraits<TSim>::VelType &velV);
         ...
         * @param velV Velocity variable
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC, const typename TSimTraits<TSim>::VelType &velV);
         ...
         * @param velV Velocity variable
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::MagType &magB, const typename TSimTraits<TSim>::VelType &velV);
         ...
         * @param codC Codensity variable
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC);
         ...
         * @param magB Magnetic variable
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::MagType &magB);
         ...
         * @param velV Velocity variable
         */
         ImposedFieldWriter(const typename TSimTraits<TSim>::VelType &velV);
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC, const typename TSimTraits<TSim>::MagType &magB, const typename TSimTraits<TSim>::VelType &velV)
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC, const typename TSimTraits<TSim>::VelType &velV)
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::MagType &magB, const typename TSimTraits<TSim>::VelType &velV)
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::CodType &codC)
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::MagType &magB)
   ...
   template <typename TSimType, template <typename> class TSimTraits> ImposedFieldWriter<TSimType, TSimTraits>::ImposedFieldWriter(const typename TSimTraits<TSim>::VelType &velV)
