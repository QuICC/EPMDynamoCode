...
namespace EPMDynamo {
    ...
    */
   template <typename TSimType, template <typename> class TSimTraits> class NavierStokesNLConvection : public NavierStokesConvection<TSimType, TSimTraits>
   {
      public:
          ...
          */
         NavierStokesNLConvection(typename TSimTraits<TSimType>::VelType &rV, typename TSimTraits<TSimType>::CodType &rC, TransformType &transform, TimestepParameters &tsteps, EquationParametersType &params);
   ...
   template <typename TSimType, template <typename> class TSimTraits> NavierStokesNLConvection<TSimType, TSimTraits>::NavierStokesNLConvection(typename TSimTraits<TSimType>::VelType &rV, typename TSimTraits<TSimType>::CodType &rC, typename NavierStokesNLConvection<TSimType, TSimTraits>::TransformType &transform, TimestepParameters &tsteps,  typename NavierStokesNLConvection<TSimType, TSimTraits>::EquationParametersType &params)
      : NavierStokesConvection<TSimType, TSimTraits>(rV, rC, transform, tsteps, params)
   {
   }

   template <typename TSimType, template <typename> class TSimTraits> void NavierStokesNLConvection<TSimType, TSimTraits>::updateRTP(const int step)
   {
   ...
   template <typename TSimType, template <typename> class TSimTraits> void NavierStokesNLConvection<TSimType, TSimTraits>::updateRHS()
   {
      // Compute \f$u\times (\nabla \times u) \f$
