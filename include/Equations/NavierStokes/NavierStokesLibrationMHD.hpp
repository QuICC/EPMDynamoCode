/** \file NavierStokesLibrationMHD.hpp
...
#ifndef NAVIERSTOKESLIBRATIONMHD_HPP
#define NAVIERSTOKESLIBRATIONMHD_HPP
...
namespace EPMDynamo {
    ...
    */
   template <typename TSimTraits> class NavierStokesLibrationMHD : public NavierStokesDiffusion<TSimTraits>
   {
      public:
          ...
          */
         NavierStokesLibrationMHD(typename TSimTraits::VelType &rV, typename TSimTraits::MagType &rB, TransformType &transform, TimestepParameters &tsteps, EquationParametersType &params);

         /**
          * @brief Simple empty destructor
          */
         virtual ~NavierStokesLibrationMHD() {};
   ...
   template <typename TSimTraits> NavierStokesLibrationMHD<TSimTraits>::NavierStokesLibrationMHD(typename TSimTraits::VelType &rV,  typename TSimTraits::MagType &rB, typename NavierStokesLibrationMHD<TSimTraits>::TransformType &transform, TimestepParameters &tsteps,  typename NavierStokesLibrationMHD<TSimTraits>::EquationParametersType &params)
      : NavierStokesDiffusion<TSimTraits>(rV, transform, tsteps, params), mrB(rB)
   {
   }

   template <typename TSimTraits> void NavierStokesLibrationMHD<TSimTraits>::updateRTP(const int step)
   {
   ...
   template <typename TSimTraits> void NavierStokesLibrationMHD<TSimTraits>::updateRHS()
   {
      // Compute \f$u\times (\nabla \times u) \f$
...
#endif // NAVIERSTOKESLIBRATIONMHD_HPP
