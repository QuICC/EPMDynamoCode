...
namespace EPMDynamo {
    ...
    */
   template <typename TSimTraits> class NavierStokesNLRotConvection : public NavierStokesConvection<TSimTraits>
   {
      public:
          ...
          */
         NavierStokesNLRotConvection(typename TSimTraits::VelType &rV, typename TSimTraits::CodType &rC, TransformType &transform, TimestepParameters &tsteps, EquationParametersType &params);
   ...
   template <typename TSimTraits> NavierStokesNLRotConvection<TSimTraits>::NavierStokesNLRotConvection(typename TSimTraits::VelType &rV, typename TSimTraits::CodType &rC, typename NavierStokesNLRotConvection<TSimTraits>::TransformType &transform, TimestepParameters &tsteps,  typename NavierStokesNLRotConvection<TSimTraits>::EquationParametersType &params)
      : NavierStokesConvection<TSimTraits>(rV, rC, transform, tsteps, params)
   {
   }

   template <typename TSimTraits> void NavierStokesNLRotConvection<TSimTraits>::updateRTP(const int step)
   {
   ...
   template <typename TSimTraits> void NavierStokesNLRotConvection<TSimTraits>::updateRHS()
   {
      // Compute \f$u\times (\nabla \times u) \f$
