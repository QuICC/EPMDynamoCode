/** \file NavierStokesNLPrecession.hpp
...
namespace EPMDynamo {
    ...
    */
   template <typename TSimTraits> class NavierStokesNLPrecession : public NavierStokesDiffusion<TSimTraits>
   {
      public:
          ...
          */
         NavierStokesNLPrecession(typename TSimTraits::VelType &rV, TransformType &transform, TimestepParameters &tsteps, EquationParametersType &params);

         /**
          * @brief Simple empty destructor
          */
         virtual ~NavierStokesNLPrecession() {};
   ...
   template <typename TSimTraits> NavierStokesNLPrecession<TSimTraits>::NavierStokesNLPrecession(typename TSimTraits::VelType &rV, typename NavierStokesNLPrecession<TSimTraits>::TransformType &transform, TimestepParameters &tsteps,  typename NavierStokesNLPrecession<TSimTraits>::EquationParametersType &params)
   ...
   template <typename TSimTraits> void NavierStokesNLPrecession<TSimTraits>::setupPrecession()
   {
   ...
   template <typename TSimTraits> void NavierStokesNLPrecession<TSimTraits>::updateRHS()
   {
      // Compute \f$u\times (\nabla \times u) \f$
