...
namespace EPMDynamo {
   ...
   template <typename TSimType, template <typename> class TSimTraits> class InductionDiffusion : public InductionBase<TSimType, TSimTraits>
   {
      public:
          ...
          */
         InductionDiffusion(typename TSimTraits<TSim>::MagType &rB, TransformType &transform, TimestepParameters &tsteps);
   ...
   template <typename TSimType, template <typename> class TSimTraits> InductionDiffusion<TSimType, TSimTraits>::InductionDiffusion(typename TSimTraits<TSim>::MagType &rB, typename InductionDiffusion<TSimType, TSimTraits>::TransformType &transform, TimestepParameters &tsteps)
