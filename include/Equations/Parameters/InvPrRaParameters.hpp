...
#ifndef INVPRRAPARAMETERS_HPP
#define INVPRRAPARAMETERS_HPP
...
namespace EPMDynamo {
    ...
    * \brief Definition of the non-dimensionalisation for non-rotating thermal convection. Based on Chandrasekhar's and Backus' work. It needs only the Prandtl number Pr and a rayleigh number
    */
   class InvPrRaParameters: public EquationParameters
   {
      public:
         ...
         */
         InvPrRaParameters(EPMFloat Pr, EPMFloat Ra);
         ...
         */
         InvPrRaParameters(const Array& arr);

         /**
         * @brief Destructor
         */
         virtual ~InvPrRaParameters() {};
   ...
   inline std::string InvPrRaParameters::type() const
   {
      return InvPrRaParameters::id;
   }

   inline int InvPrRaParameters::nParams() const
   {
      return 2;
   }

   inline EPMFloat InvPrRaParameters::Pr() const
   {
      return this->mPr;
   }

   inline EPMFloat InvPrRaParameters::Ra() const
   {
      return this->mRa;
   }
}

#endif // INVPRRAPARAMETERS_HPP
