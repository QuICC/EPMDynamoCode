...
namespace EPMDynamo {
   ...
   {
      EPMSHARED_PTR<SourceFileWriter<TSimType, TGenTraits> >  pOutFile;
      ...
      {
         pOutFile.reset(new SourceFileWriter<TSimType, TGenTraits>(this->codC(), this->magB(), this->velV()));
