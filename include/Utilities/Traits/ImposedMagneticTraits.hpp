/** \file ImposedMagneticTraits.hpp
 *  \brief Traits for the magneto-convection simulation implementation
 */

#ifndef IMPOSEDMAGNETICTRAITS_HPP
#define IMPOSEDMAGNETICTRAITS_HPP
...
namespace EPMDynamo {
    ...
    */
   template <typename TSimType> class ImposedMagneticTraits
   {
      public:
...
#endif // IMPOSEDMAGNETICTRAITS_HPP
